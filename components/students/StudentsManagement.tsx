...
export default function StudentManagement() {
  ...
  const studentsSummary = analyticsData?.data?.students?.summary;
        ...
        {isAnalyticsLoading ? (
          ...
          <>
            <StatCard
              ...
              value={studentsSummary?.totalStudents ?? stats?.totalStudents ?? 0}
              sub={`${studentsSummary?.activeStudents ?? 0} active students`}
              icon={Users}
              color="blue"
            />
            <StatCard
              ...
              sub={`${enrollmentSummary?.totalCompleted ?? 0} completed`}
              icon={TrendingUp}
              color="violet"
            />
            <StatCard
              ...
              sub={`${stats?.totalActiveCourses ?? 0} active courses`}
              icon={BookOpen}
              color="amber"
            />
            <StatCard
      ...
      <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete{" "}
              <strong>{deletingStudent?.name}</strong>? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="flex gap-2">
            <AlertDialogCancel disabled={isDeleting}>Cancel</AlertDialogCancel>
