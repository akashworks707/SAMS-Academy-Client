...
const createTeacherSchema = z
  .object({
    ...
    dateOfBirth: z.string().optional(),
    qualification: z.string().min(2, "Please enter a qualification"),
    designation: z.string().optional(),
    experience: z.preprocess(
      (val) => (val !== "" && val !== undefined ? Number(val) : undefined),
      z.number().min(0).optional()
        ...
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input id="t-name" placeholder="e.g. John Smith" {...register("name")} />
                  {errors.name && <p className="text-xs text-red-400">{errors.name.message}</p>}
                </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input id="t-qualification" placeholder="e.g. MSc in Mathematics" {...register("qualification")} />
                  {errors.qualification && (
                    <p className="text-xs text-red-400">{errors.qualification.message}</p>
                  )}
                </div>

                <div className="space-y-1.5">
                  <Label htmlFor="t-designation" className="text-xs font-semibold tracking-widest uppercase">
                    Designation <span className="text-[#96999A] normal-case font-normal">(optional)</span>
                  </Label>
                  <Input id="t-designation" placeholder="e.g. Senior Math Teacher" {...register("designation")} />
                </div>

                <div className="space-y-1.5">
                  <Label htmlFor="t-experience" className="text-xs font-semibold tracking-widest uppercase">
                    Experience (years) <span className="text-[#96999A] normal-case font-normal">(optional)</span>
                  </Label>
                  <Input id="t-experience" type="number" min={0} placeholder="e.g. 5" {...register("experience")} />
                  {errors.experience && (
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="t-salary" className="text-xs font-semibold tracking-widest uppercase">
                    Monthly Salary (BDT) <span className="text-[#96999A] normal-case font-normal">(optional)</span>
                  </Label>
                  <Input id="t-salary" type="number" min={0} placeholder="e.g. 45000" {...register("salary")} />
                  {errors.salary && <p className="text-xs text-red-400">{errors.salary.message}</p>}
                </div>

                <div className="space-y-1.5">
                  <Label htmlFor="t-perclass" className="text-xs font-semibold tracking-widest uppercase">
                    Per Class Salary (BDT) <span className="text-[#96999A] normal-case font-normal">(optional)</span>
                  </Label>
                  <Input id="t-perclass" type="number" min={0} placeholder="e.g. 200" {...register("perClassSalary")} />
                  {errors.perClassSalary && (
                    <p className="text-xs text-red-400">{errors.perClassSalary.message}</p>
                  )}
                </div>
              ...
              <div className="space-y-1.5 mt-4">
                <Label htmlFor="t-bio" className="text-xs font-semibold tracking-widest uppercase">
                  Bio <span className="text-[#96999A] normal-case font-normal">(optional)</span>
                </Label>
                <Textarea
                  id="t-bio"
                  placeholder="Write a short bio for the teacher..."
                  rows={3}
                  {...register("bio")}
                />
                {errors.bio && <p className="text-xs text-red-400">{errors.bio.message}</p>}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <Label htmlFor="t-division" className="text-xs font-semibold tracking-widest uppercase">Division</Label>
                  <Input id="t-division" placeholder="e.g. Dhaka" {...register("division")} />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="t-district" className="text-xs font-semibold tracking-widest uppercase">District</Label>
                  <Input id="t-district" placeholder="e.g. Dhaka" {...register("district")} />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="t-thana" className="text-xs font-semibold tracking-widest uppercase">Thana</Label>
                  <Input id="t-thana" placeholder="e.g. Mirpur" {...register("thana")} />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="t-union" className="text-xs font-semibold tracking-widest uppercase">Union / Ward</Label>
                  <Input id="t-union" placeholder="e.g. Ward-10" {...register("union")} />
                </div>
              </div>
            </div>
